 ...
 */
package io.cloudoffice.platform.cockpit.metrics;

import io.cloudoffice.platform.cockpit.microservice.metrics.MetricsMicroservice;
...
public class Startup extends Bootstrap {
    ...
    public Startup(int threadnum, Class... microservice) {
        super(threadnum, microservice);
    }
    ...
    public static void main(String[] args) throws Exception {
        Bootstrap.start(new Startup(200, MetricsMicroservice.class));
    }
}
