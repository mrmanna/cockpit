 ...
 */
@UnstableApi
public class Http2MultiplexCodecX extends Http2FrameCodecX {
    ...
    Http2MultiplexCodecX(Http2ConnectionEncoder encoder,
        ...
        private final class Http2ChannelUnsafe implements Unsafe {
            ...
            private void firstWriteComplete(ChannelFuture future, ChannelPromise promise) {
                ...
                if (cause == null) {
                    ...
                    writabilityChanged(Http2MultiplexCodecX.this.isWritable(stream));
                    promise.setSuccess();
                } else {
            ...
            private ChannelFuture write0(Object msg) {
                ...
                Http2MultiplexCodecX.this.write(ctx, msg, promise);
                return promise;
            }
